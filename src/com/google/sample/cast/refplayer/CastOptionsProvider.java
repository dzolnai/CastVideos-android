...
public class CastOptionsProvider implements OptionsProvider {
    ...
    public CastOptions getCastOptions(Context context) {
        ...
        CastMediaOptions mediaOptions = new CastMediaOptions.Builder()
                .setImagePicker(new NewImagePickerImpl())
    ...
    private static class ImagePickerImpl extends ImagePicker {
        ...
        public WebImage onPickImage(MediaMetadata mediaMetadata, int type) {
            Log.e("CAST IMAGE PICKER [OLD]", "Called with type: " + type);
    ...
    private static class NewImagePickerImpl extends ImagePicker {

        @Override
        public WebImage onPickImage(MediaMetadata mediaMetadata, @NonNull ImageHints imageHints) {
            Log.e("CAST IMAGE PICKER [NEW]", "Called with type: " + imageHints.getType());
            if ((mediaMetadata == null) || !mediaMetadata.hasImages()) {
                return null;
            }
            List<WebImage> images = mediaMetadata.getImages();
